...
const Booking = () => {
  return (
    ...
    <div className='bg-slate-200 max-w-md mx-auto p-4 '>                                                                              
        
            <h3 className='text-2xl text-center text-blue-800'>Book Your Swim</h3>
          <div className='w-full p-2'>
            <label className='flex font-lg pl-4 gap-2 p-2'><SlCalender size={20}/> Select Date</label>
            <input type="date"  className='w-full p-4 border bg-slate-50 shadow-sm rounded-md py-2'/>
          </div>
          <div>
            <label className='flex font-lg p-2 pl-6 gap-2'><BsClock size={20}/>Select Time</label>
          ...
          <div >
            <label className='flex font-lg pl-4 gap-2 p-2'> <BiGlobe size={24}/>  Select Slot</label>
          ...
          <div>
            <label className='flex p-4'>Water Level</label>
